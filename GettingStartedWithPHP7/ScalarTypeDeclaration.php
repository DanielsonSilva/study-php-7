...
Testing the function passing an <i>int (100)</i> value:<?= sendHappiness(100) ?><br>
Testing the function passing an <i>string ("100")</i> value:<?= sendHappiness("100") ?><br>
Testing the function passing an <i>string ("hello")</i> value:<?= sendHappiness("hello") ?><br>
Testing the function passing an <i>string ("56.78")</i> value:<?= sendHappiness("56.78") ?><br>
Testing the function passing an <i>string ("true")</i> value:<?= sendHappiness("true") ?><br>
Testing the function passing an <i>string ("false")</i> value:<?= sendHappiness("false") ?><br>
Testing the function passing an <i>float (12.34)</i> value:<?= sendHappiness(12.34) ?><br>
Testing the function passing an <i>boolean (true)</i> value:<?= sendHappiness(true) ?><br>
Testing the function passing an <i>boolean (false)</i> value:<?= sendHappiness(false) ?><br>
<br>
<!-- TEST WITH INT -->
<?php 
...
?>
<b>Function created:</b><br>
function sendString(<b>string</b> $a) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;var_dump($a);<br>
}<br><br>
...
?>
<b>Function created:</b><br>
function sendFloat(<b>float</b> $a) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;var_dump($a);<br>
}<br><br>
...
?>
<b>Function created:</b><br>
function sendBoolean(<b>bool</b> $a) {<br>
&nbsp;&nbsp;&nbsp;&nbsp;var_dump($a);<br>
}<br><br>
